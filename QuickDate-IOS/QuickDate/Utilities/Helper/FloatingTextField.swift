...
class FloatingTextField: UITextField {
    ...
    private var attributedTitle: NSAttributedString? {
        ...
        fnameAttributedString.addAttribute(NSAttributedString.Key.font, value: Typography.regularText(size: 12).font , range: boldRange)
    ...
    var titleFont: UIFont = Typography.regularText(size: 12).font {
        didSet {
    ...
    private var textfeildFont: UIFont {
        return Typography.regularText(size: 12).font
    }
    ...
    func setTitle(title: String, isMandatory: Bool = false) {
        ...
        if isMandatory {
            ...
            self.attributedPlaceholder = NSAttributedString(string: "title", attributes: [
                .font: Typography.regularText(size: 12).font
            ])
