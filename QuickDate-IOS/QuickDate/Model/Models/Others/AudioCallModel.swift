...
import Foundation
class CreateAudioCallModel:BaseModel{
   
    struct CreateAudioCallSuccessModel: Codable {
        let status: Int?
        let data: DataClass?
    ...
    struct User: Codable {
        ...
        let mobileTokenCreatedAt, mobileDevice, interest:String?
...
class CheckForAudioCallAnswerModel:BaseModel{
   
    
    // MARK: - Welcome
    struct CheckForAudioCallAnswerSuccessModel: Codable {
        let status: Int?
        let data: DataClass?
...
class DeclineAudioCallModel:BaseModel{
    
    
    // MARK: - Welcome
    struct DeclineAudioSuccessCallModel: Codable {
        let status: Int
        let message: String
...
class AnswerAudioCallModel:BaseModel{
  
    struct AnswerAudioCallSuccessModel: Codable {
        let status: Int
        let data: DataClass
...
class DeleteAudioCallModel:BaseModel{
