...
//        collectionView.register(R.nib.peopleILikeCollectionItem(), forCellWithReuseIdentifier: R.reuseIdentifier.peopleILikeCollectionItem.identifier)
        
        
        let peopleILikeCollectionItem = UINib(nibName: "PeopleILikeCollectionItem", bundle: nil)
        collectionView.register(peopleILikeCollectionItem, forCellWithReuseIdentifier: R.reuseIdentifier.peopleILikeCollectionItem.identifier)
                ...
                if (currentHour - epochHour == 0) {
                    if (currentMinutes - epochMinutes == 0) {
                        if (currentSeconds - epochSeconds <= 1) {
                            return String(abs(currentSeconds - epochSeconds)) + " second ago"
                        } else {
                            return String(abs(currentSeconds - epochSeconds)) + " seconds ago"
                        }
                        
                    } else if (currentMinutes - epochMinutes <= 1) {
                        return String(abs(currentMinutes - epochMinutes)) + " minute ago"
                    } else {
                        return String(abs(currentMinutes - epochMinutes)) + " minutes ago"
                    }
                } else if (currentHour - epochHour <= 1) {
                    return String(abs(currentHour - epochHour)) + " hour ago"
                } else {
                    return String(abs(currentHour - epochHour)) + " hours ago"
                }
            } else if (currentDay - epochDay <= 1) {
                return String(abs(currentDay - epochDay)) + " day ago"
            } else {
                return String(abs(currentDay - epochDay)) + " days ago"
            }
        } else {
            return String(abs(epochDay)) + " " + getMonthNameFromInt(month: epochMonth) + " " + String(epochYear)
        }
    }
